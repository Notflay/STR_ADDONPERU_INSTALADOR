...
BEGIN
/*************************************************************************************************************************
			TITULO: Procedimiento para Add-on Letras (Estado de Cta Corriente de Socio)	
			Fecha Creaci�n: 06/08/2014																				    
			Hecho por: NCONDORI																						    
			Fecha Modificaci�n: 06/08/2014																			    
			Modificado por: NCONDORI																				    
																																				    
			DESCRIPCION: Inicio del procedimiento en su version hana con respecto a la version MSSQL.
						no se estan utilizando tablas temporales, sino estan leyendose directamente en el from tanto
						para la obtencion de Documentos y Asientos.						
...
--		and T0."DocEntry" not in (select "U_DocEntry" from "@ST_LT_EMILET" TX0 inner join "@ST_LT_ELDOCS" TX1
		...
		--and T0."DocEntry" not in (select "U_DocEntry" from "@ST_LT_EMILET" TX0 inner join "@ST_LT_ELDOCS" TX1
		--on TX0."DocEntry" = TX1."DocEntry" where TX0."U_CardCode" = t0."CardCode" and "U_DocStat" = 'A')
