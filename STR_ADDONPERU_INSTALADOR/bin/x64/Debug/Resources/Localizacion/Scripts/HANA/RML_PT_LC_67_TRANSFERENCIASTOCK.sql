CREATE PROCEDURE RML_PT_LC_67_TRANSFERENCIASTOCK
(
	IN id NVARCHAR(50),
...
-- ACTUALIZA CORRELATIVO
		IF :transaction_type = 'A' THEN
			...
			select "U_BPP_MDTD","U_BPP_MDSD","U_BPP_MDCD","CANCELED" INTO tp,sr,sNumero,cancelado from OWTR where "DocEntry"= TO_INTEGER(:id);
