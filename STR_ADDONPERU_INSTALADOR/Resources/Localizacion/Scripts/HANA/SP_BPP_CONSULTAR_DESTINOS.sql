...
BEGIN
    ...
    SELECT IFNULL("U_BPP_CNTDOPCN",'1') INTO CUENTAOPC FROM "@BPP_PARAMS";
	...
	IF :CUENTAOPC = '2' THEN
		SELECT 
	        ...
	        T3."U_STR_LC_CDST" AS "CuentaDestino",
	        T1."FormatCode" AS "CuentaNaturaleza",
	        CASE 
	            WHEN T0."DebCred" = 'C' THEN -IFNULL(T0."Credit", 0) 
	            ELSE IFNULL(T0."Debit", 0) 
	...
	IF :CUENTAOPC = '3' THEN
		SELECT 
	        ...
	        T4."U_RML_CNTDEST" AS "CuentaDestino",
	        T1."FormatCode" AS "CuentaNaturaleza",
	        CASE 
	            WHEN T0."DebCred" = 'C' THEN -IFNULL(T0."Credit", 0) 
	            ELSE IFNULL(T0."Debit", 0) 
